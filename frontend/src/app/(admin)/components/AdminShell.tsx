    ...
    <div className="min-h-screen pb-12">
      <header className="sticky top-0 z-40 pt-4 pb-3 backdrop-blur-md bg-primary/70 border-b border-faded/10">
        <div className="w-7/8 mx-auto flex items-center justify-between gap-4">
          ...
          >
            <Image src="/blueprint.png" alt="Blueprint" width={42} height={42} />
            <div>
              <div className="text-xl font-semibold leading-tight">Blueprint</div>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              href="/app"
              className="rounded-xl border border-faded/20 bg-secondary/50 px-3 py-2 text-sm hover:bg-secondary transition ease-in-out"
            >
              Frontend megnyitása
            </Link>
