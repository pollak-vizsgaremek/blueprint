export const CalendarPanel = () => {
  return (
    <div className="grow flex p-2 justify-between cursor-pointer rounded-xl">
      <div className="w-2/3 m-auto h-full hover:bg-faded/30 transition ease-in-out border-[2px] flex flex-col justify-between rounded-md border-faded/40 ">
