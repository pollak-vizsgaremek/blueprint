                ...
                (_, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative flex h-8 max-md:h-5 items-center justify-center overflow-hidden rounded-[2px] border px-0.5 text-center text-[9px] leading-tight sm:h-9 sm:text-[10px] ${
                        isWall
