...
export const GlassButton = ({
  ...
  return (
    <button
      className={`group relative px-8 py-4 font-semibold text-white rounded-full overflow-hidden transition-all duration-300 ease-out hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl ${className}`}
      {...props}
    >
